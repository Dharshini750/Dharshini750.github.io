...
export const Index = () => {
  return (
    <div className="primary w-full h-[92.4vh] flex flex-col justify-center items-center">
      ...
      <div className="w-[100%] h-[30%] flex flex-col justify-center items-center align-middle gap-4">
        <Link to="/login">
